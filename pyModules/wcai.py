...
# Mode variable
current_mode = "draw"  # Initial mode is drawing
...
def update_webcam_canvas():
    ...
    if ret:
        ...
        if drawing and current_mode == "draw":
...
# Create mode buttons
draw_button_mode = Button(webcam_root, text="Drawing Mode", command=lambda: switch_mode("draw"))
draw_button_mode.pack(side=tk.LEFT)
recognize_button_mode = Button(webcam_root, text="Text Recognition Mode", command=lambda: switch_mode("recognize"))
